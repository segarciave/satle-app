...
final_df = df_selection.rename(columns={'organizationName': 'Organization Name',
                                        ...
                                        'hasEmissionInventory': 'Emission Inventory',
                                        ...
                                        'hasFinanceActions': 'Finance Actions',
                                        'engagement_sourceDescription': 'Source Description',
                                        'engagement_sourceLink': 'Source Link'})
...
left_column, middle_column, right_column = st.columns(3)
with middle_column:
    st.image(Image.open("Logos/NF_HEA_GOVMT_logos.png"), width=400)
